...
public class Chats extends AppCompatActivity {
    ...
    private void setupClickListeners() {
        ...
        btnStartChat.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Chats.this, AddDormActivity.class);
    ...
    private void loadChats() {
        ...
        mDatabase.child("chats").child(userId).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                aiAssistant.setLastMessage("Hello! I'm here to help you find the perfect property. Ask me anything!");
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(Chats.this, "Failed to load chats", Toast.LENGTH_SHORT).show();
            }
        });
    }
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Report", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Toast.makeText(Chats.this, "User reported", Toast.LENGTH_SHORT).show();
                    }
                })
    ...
    private class ChatAdapter extends RecyclerView.Adapter<ChatAdapter.ChatViewHolder> {
        ...
        public ChatViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(Chats.this).inflate(R.layout.chat_item_layout, parent, false);
        ...
        public void onBindViewHolder(@NonNull ChatViewHolder holder, int position) {
            ...
            // Profile and status
            if (isAI) {
                holder.ivProfilePic.setImageResource(android.R.drawable.ic_lock_idle_lock); // App logo
